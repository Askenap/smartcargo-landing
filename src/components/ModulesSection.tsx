        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="border border-border rounded-2xl p-8 hover:shadow-lg transition-shadow">
            ...
            <div className="space-y-2 mb-4">
              {["Один QR вместо «папки бумажек» и объяснений", "Подходит для разных проверок: граница, ЕАЭС (СНТ), перевозки по РК", "Документы подтягиваются из государственных систем — вручную не нужно ничего заполнять"].map((t) => (
