...
const modules = [
  ...
  { icon: Zap, title: "Верифицированный проход государственной границы", description: "Водитель заранее подтверждает готовность документов и груза - на границе очередь и проверки проходит быстрее, без лишних задержек." },
